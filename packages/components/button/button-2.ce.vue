  ...
  <div class="voltage-button">
    ...
    >
      ...
      <path
        ...
        fill="transparent"
        stroke="var(--line1-stroke, #f6de8d)"
      ></path>
      <path
        ...
        fill="transparent"
        stroke="var(--line2-stroke, #6bfeff)"
      ></path>
    </svg>
    <div class="dots">
...
<script>
export default {
  name: "ar-button-voltage",
};

// 文档绑定：打包 Web Components 时，读取此属性即可自动生成组件文档
export const meta = {
  name: "ar-button-voltage",
  type: "button",
  theme: "dark",
  slot: "Button",
  variables: [
    { name: "--width", description: "组件宽度", default: "auto" },
    { name: "--height", description: "组件高度", default: "auto" },
    { name: "--btn-color", description: "按钮文字颜色", default: "white" },
    { name: "--btn-background", description: "按钮背景颜色", default: "#0d1127" },
    { name: "--btn-padding", description: "按钮内边距", default: "1rem 3rem" },
    { name: "--btn-border-radius", description: "按钮圆角", default: "5rem" },
    { name: "--btn-border", description: "按钮边框样式", default: "5px solid #5978f3" },
    { name: "--btn-font-size", description: "按钮字体大小", default: "1.2rem" },
    { name: "--btn-line-height", description: "按钮行高", default: "1em" },
    { name: "--btn-letter-spacing", description: "按钮字间距", default: "0.075em" },
    { name: "--btn-transition", description: "按钮过渡动画", default: "background 0.3s" },
    { name: "--btn-hover-background", description: "按钮悬停时背景颜色", default: "#0f1c53" },
    { name: "--line1-stroke", description: "SVG 第 1 条路径颜色", default: "#f6de8d" },
    { name: "--line2-stroke", description: "SVG 第 2 条路径颜色", default: "#6bfeff" },
    { name: "--dot-color", description: "发光小点颜色", default: "white" },
    { name: "--dot-size", description: "发光小点尺寸", default: "1rem" },
    { name: "--svg-opacity", description: "SVG 初始透明度", default: "0" },
    { name: "--svg-transition", description: "SVG 过渡动画效果", default: "opacity 0.4s" },
  ],
};
</script>
...
/* 按钮样式部分，通过 CSS 变量支持定制 */
.voltage-button button {
  color: var(--btn-color, white);
  background: var(--btn-background, #0d1127);
  padding: var(--btn-padding, 1rem 3rem);
  border-radius: var(--btn-border-radius, 5rem);
  border: var(--btn-border, 5px solid #5978f3);
  font-size: var(--btn-font-size, 1.2rem);
  line-height: var(--btn-line-height, 1em);
  letter-spacing: var(--btn-letter-spacing, 0.075em);
  transition: var(--btn-transition, background 0.3s);
...
.voltage-button button:hover {
  cursor: pointer;
  background: var(--btn-hover-background, #0f1c53);
}
...
.voltage-button svg {
  ...
  pointer-events: none;
  opacity: var(--svg-opacity, 0);
  transition: var(--svg-transition, opacity 0.4s);
